...
class Farmform(FlaskForm):
    ...
    vegenum = StringField("How many of these vegetables are you selling? Separate with a comma, thank you.", validators=[InputRequired()])
    fruits = StringField("What fruits do you sell? Separate with a comma, thank you.", validators=[InputRequired()])
    fruitnum = StringField("How many of these vegetables are you selling? Separate with a comma, thank you.", validators=[InputRequired()])
